...
import wojakImg from "../../assets/wojak.avif";
...
export const Contact = () => {
  ...
  return (
    <div className="min-h-[70vh] flex flex-col py-8">
      ...
      <div className="flex flex-col items-center justify-center py-16 select-none pointer-events-none">
        <img src={wojakImg} alt="" className="w-[47rem] h-auto opacity-[0.15]" style={{ maskImage: "radial-gradient(ellipse at 50% 50%, black 30%, transparent 60%)", WebkitMaskImage: "radial-gradient(ellipse at 50% 50%, black 30%, transparent 60%)" }} />
        <p className="text-white text-base mt-4 font-semibold tracking-wider opacity-[0.08]">
          {t("contact.pleaseContactMe", { ns: "contact" })}
        </p>
      </div>
    </div>
  );
